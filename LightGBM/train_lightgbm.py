...
def log_model(clf):
    joblib.dump(clf, 'outputs/ligbm_titanic.pkl')
    run.upload_file('lgbm.pkl', 'outputs/ligbm_titanic.pkl')
    run.register_model(model_name='lgbm_titanic', model_path='outputs/ligbm_titanic.pkl')
